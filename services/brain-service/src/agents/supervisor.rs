...
impl SupervisorAgent {
    pub fn select_agent(intent: &Intent) -> String {
        match intent {
            Intent::ReportDisease
            | Intent::AskFertilizerRecommendation => "agronomist_agent".into(),

            Intent::CheckStock
            | Intent::CheckHarvestStatus
            | Intent::ReportActivity => "farm_agent".into(),
            ...
            Intent::BuyProduct
            | Intent::CheckPrice => "marketplace_agent".into(),
